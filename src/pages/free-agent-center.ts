...
interface FreeAgentCards {
    [id: string]: HTMLElement;
}

class FreeAgentVisualizer {
    private container: HTMLElement | null = null;
    private freeAgents: Roster | null = null;
    private freeAgentCards: FreeAgentCards | null = null;
    ...
    private addBadges(): void {
        if (!this.freeAgentCards || !this.freeAgents) return;
...
export function manipulateFreeAgentCenterPage(el: HTMLElement) {
